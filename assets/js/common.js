    ...
    <div id="root" class="header-box">
      <div id="topnav" class="topnav">
        ...
        <nav role="navigation" id="topnav_menu">
          ...
          <a class="topnav_link" href="comingSoon.html">Comming Soon</a>
        </nav>
        ...
        <nav role="navigation" id="topnav_responsive_menu">
          <ul>
            ...
            <li><a class="topnav_link" href="comingSoon.html">Comming Soon</a></li>
    ...
    footer.innerHTML = `
        ...
        <p class="m-f">&copy; 2024 EZ BIKE</p>
            <ul class="m-0 d-flex g-2 wrap">
                ...
                <li><a class="link-footer" href="/comingSoon.html">Comming Soon</a></li>
                </ul>
            </div>
    `
